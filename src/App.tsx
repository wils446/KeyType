...
import { ScoreDisplay, Typing } from "./components";
import { useDarkMode, useDisplayWords } from "./hooks";
...
function App() {
    ...
    return (
        <div className={theme}>
            <div className="App bg-white dark:bg-gradient-to-tr dark:from-gray-900 dark:to-gray-800">
                <div className="container mx-auto h-screen invisible md:visible">
                    ...
                    <div className="flex w-full item-centers justify-center">
                        {showScore ? (
                            <ScoreDisplay
                                nextGame={nextGame}
